...
//   console.log("hi");
//   connect.dropCollection("users", (err, result) => {
//     if (err) {
//       console.log("error delete collection");
//     } else {
//       console.log("delete users collection success");
//     }
//   });

//   connect.dropCollection("restaurants", (err, result) => {
//     if (err) {
//       console.log("error delete restaurants collection");
//     } else {
//       console.log("delete restaurants collection success");
//     }
//   });
//   connect.dropCollection("nightlifes", (err, result) => {
//     if (err) {
//       console.log("error delete nightlifes collection");
//     } else {
//       console.log("delete nightlifes collection success");
//     }
//   });
//   connect.dropCollection("daytrips", (err, result) => {
//     if (err) {
//       console.log("error delete daytrips collection");
//     } else {
//       console.log("delete daytrips collection success");
//     }
//   });
//   connect.dropCollection("thingstodos", (err, result) => {
//     if (err) {
//       console.log("error delete thingstodos collection");
//     } else {
//       console.log("delete thingstodos collection success");
//     }
//   });
